...
sunflo <- list(
  ...
  predictors = read_excel(list_parameter, sheet="predictors")
)
...
# Summary
SUNFLO^[model version: tag 1.4, commit SHA `4d5c30d3`, \href{git clone http://mulcyber.toulouse.inra.fr/anonscm/git/sunrise/sunrise.git sunflo}{repository}] is a process-based model for the sunflower crop which was developped to simulate the grain yield and oil concentration as a function of time ($t$), environment ($E$) which includes soil, climate and management practice and genetic diversity ($G$) [@Debaeke2010; @Casadebaig2011; @Lecoeur2011].  
...
## Management
```{r InputsManagement, echo=FALSE, results='asis', eval=FALSE}
...
## PhenoStages
```{r PhenoStages, echo=FALSE, fig.width=8, fig.height=2, fig.fullwidth=TRUE}
# data
...
```{r InputsLightInterception, echo=FALSE, results='asis'}
# data
...
```{r InputsBiomass, echo=FALSE, results='asis'}
# data
...
## Harvest Index
```{r InputsHarvestIndex, echo=FALSE, results="asis"}
# data
...
## Oil Content
```{r InputsOilContent, echo=FALSE, results="asis"}
# data
...
```{r InputsWaterStress, echo=FALSE, results='asis'}
# data
...
```{r WaterStressEvaporation, echo=FALSE, fig.width=4, fig.height=4, fig.margin=TRUE}
# function
...
```{r WaterStressMineralization, echo=FALSE, fig.width=4, fig.height=4, fig.margin=TRUE}
# function
...
```{r InputsNitrogenStress, echo=FALSE, results='asis'}
# data
...
```{r NitrogenAbsorbedTransport, echo=FALSE, fig.width=4, fig.height=4, fig.margin=TRUE, eval=FALSE}
# equation
