...
$$WaterTotal = (WaterSoilCapacity - WaterSoilWilting) * SoilDensity * (1 - StoneContent) * RootingDepth$$
...
# data
s <- sunflo$outputs %>% select(label=label.doc, description=label.en, unit)
# table
kable(s, padding=0)
```
