...
system("dot -T pdf -o ./files/structure.pdf ./files/structure.dot")
system("dot -T png -o ./files/structure.png ./files/structure.dot")

# Replace nodes names by points 
system("dot -T png -o ./files/structure_simple.png ./files/structure.dot -Nlabel= -Nshape=circle")
```
...
# s <- readWorksheetFromFile(file="./files/equations.xlsx", sheet="sunflo")
```
