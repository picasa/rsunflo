...
$$PotentialLeafArea_i = PotentialLeafSize \cdot exp^{a \cdot (\frac{i-PotentialLeafProfile}{PotentialLeafProfile-1})^2 + b \cdot (\frac{i-PotentialLeafProfile}{PotentialLeafProfile-1})^3}$$
